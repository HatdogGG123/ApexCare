...
<body class="relative w-full h-dvh bg-white text-dark-blue text-sm font-display">
    ...
    <aside id="filterPanel" class="hidden fixed z-60 flex items-end justify-end bg-gray-600/40 w-full h-dvh">
        ...
        <section class="relative z-10 w-full h-[80dvh] bg-white shadow-2xl flex flex-col justify-between font-display lg:h-dvh lg:w-[40%] xl:w-[25%]">
            ...
            <section class="p-5 border-b flex items-center justify-between bg-gray-50/50">
                ...
                <button id="closeFilterBtn" type="button" class="closeFilterBtn text-gray-400 hover:text-gray-600 transition-colors p-1">
        ...
        <section class="w-full h-[80%] flex flex-col bg-white p-6 justify-between lg:h-dvh lg:w-[40%] xl:w-[25%] overflow-y-auto scrollbar-none">
            ...
            <section class="flex flex-col w-full gap-6 items-start justify-between">
                ...
                <section class="flex items-start justify-between pb-2 w-full border-b border-gray-100">
                    ...
                    <button id="closeViewDetailPanelBtn" class="closeViewDetailPanelBtn text-gray-400 transition-colors cursor-pointer hover:text-gray-600 p-1">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                        </svg>
                    </button>
                ...
                <section class="flex flex-col gap-3 w-full">
                    ...
                    <!-- Items Container -->
                    <section class="flex flex-col gap-2.5 max-h-[320px] overflow-y-auto pr-1">

                        <!-- Item 1 -->
                        <section class="bg-gray-50 p-3 rounded-xl border border-gray-100 flex flex-col gap-2">
                ...
                <section class="flex flex-col gap-3 w-full">
                    ...
                    <section class="relative pl-6 space-y-4 before:absolute before:left-2 before:top-2 before:bottom-2 before:w-0.5 before:bg-emerald-500">
                        ...
                        <section class="relative flex flex-col">
                            <span class="absolute -left-[21px] top-1 h-3.5 w-3.5 rounded-full bg-emerald-500 ring-4 ring-white"></span>
                            <p class="text-xs font-bold text-gray-900 leading-none">Creation Date</p>
                            <p class="text-[11px] text-gray-500 mt-0.5">Aug 20, 2026 • 09:15 AM</p>
                        </section>

                        <!-- Order Date -->
                        <section class="relative flex flex-col">
                            <span class="absolute -left-[21px] top-1 h-3.5 w-3.5 rounded-full bg-emerald-500 ring-4 ring-white"></span>
                            <p class="text-xs font-bold text-gray-900 leading-none">Order Date</p>
                            <p class="text-[11px] text-gray-500 mt-0.5">Aug 21, 2026 • 10:30 AM</p>
                        </section>

                        <!-- Submitted Date -->
                        <section class="relative flex flex-col">
                            <span class="absolute -left-[21px] top-1 h-3.5 w-3.5 rounded-full bg-emerald-500 ring-4 ring-white"></span>
                            <p class="text-xs font-bold text-gray-900 leading-none">Submitted Date</p>
                            <p class="text-[11px] text-gray-500 mt-0.5">Aug 21, 2026 • 02:00 PM</p>
                        </section>

                        <!-- Approved Date -->
                        <section class="relative flex flex-col">
                            <span class="absolute -left-[21px] top-1 h-3.5 w-3.5 rounded-full bg-emerald-500 ring-4 ring-white"></span>
                            <p class="text-xs font-bold text-gray-900 leading-none">Approved Date</p>
                            <p class="text-[11px] text-gray-500 mt-0.5">Aug 22, 2026 • 08:45 AM</p>
                        </section>

                        <!-- Arrived Date -->
                        <section class="relative flex flex-col">
                            <span class="absolute -left-[21px] top-1 h-3.5 w-3.5 rounded-full bg-emerald-500 ring-4 ring-white"></span>
                            <p class="text-xs font-bold text-gray-900 leading-none">Arrived Date</p>
                            <p class="text-[11px] text-gray-500 mt-0.5">Aug 22, 2026 • 01:15 PM</p>
                        </section>

                        <!-- Completed Date -->
                        <section class="relative flex flex-col">
                            <span class="absolute -left-[21px] top-1 h-3.5 w-3.5 rounded-full bg-emerald-500 ring-4 ring-white"></span>
                            <p class="text-xs font-bold text-gray-900 leading-none">Completed Date</p>
                            <p class="text-[11px] text-gray-500 mt-0.5">Aug 22, 2026 • 03:30 PM</p>
                        </section>
                ...
                <section class="w-full">
                    <section class="flex justify-between font-bold text-gray-900 text-base border-t border-gray-200 pt-2 mt-0.5">
    ...
    <aside id="addRecordPanel" class="hidden fixed z-60 flex items-end justify-end bg-gray-600/40 w-full h-dvh">
        ...
        <section class="relative z-10 w-full h-[80dvh] bg-white shadow-2xl flex flex-col justify-between font-display lg:h-dvh lg:w-[40%] xl:w-[25%]">
            ...
            <section class="p-5 border-b flex items-center justify-between bg-gray-50/50">
                ...
                <button id="closeAddRecordBtn" type="button" class="closeAddRecordBtn text-gray-400 hover:text-gray-600 transition-colors p-1">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                    </svg>
                </button>
            ...
            <section class="p-5 overflow-y-auto flex-1 flex flex-col gap-5 text-sm scrollbar-none">
                ...
                <section class="flex flex-col gap-3">
                    ...
                    <section class="relative">
                        ...
                        <section class="relative">
                            <input type="text" placeholder="Search medicine name..." class="w-full bg-gray-50 border border-gray-300 rounded-lg py-2.5 pl-9 pr-3 text-sm focus:ring-2 focus:ring-secondary focus:outline-none" />
                    ...
                    <!-- Brand Dropdown -->
                    <section>
                        <label class="block text-xs font-semibold text-gray-700 mb-1">Select Brand</label>
                        <select class="w-full bg-gray-50 border border-gray-300 rounded-lg p-2.5 text-sm focus:ring-2 focus:ring-secondary focus:outline-none">
                            ...
                            <option value="allercur">Allercur</option>
                    ...
                    <section class="flex flex-col gap-2.5">
                        ...
                        <section class="bg-gray-50 p-3 rounded-xl border border-gray-200 flex flex-col gap-2 relative group">
                            <section class="flex justify-between items-start pr-6">
                                <section>
                                    <p class="font-semibold text-gray-900 text-sm leading-tight">Amoxil</p>
                                    <p class="text-xs text-gray-500 mt-0.5">Amoxicillin • 500mg Capsule</p>
                                </section>
                                <p class="font-bold text-gray-900 text-sm">₱30.00</p>
                            </section>
                            <section class="flex justify-between items-center border-t border-gray-200/60 pt-2 text-xs text-gray-600">
                        ...
                        <section class="bg-gray-50 p-3 rounded-xl border border-gray-200 flex flex-col gap-2 relative group">
                            <section class="flex justify-between items-start pr-6">
                                <section>
                                    <p class="font-semibold text-gray-900 text-sm leading-tight">Biogesic</p>
                                    <p class="text-xs text-gray-500 mt-0.5">Paracetamol • 500mg Tablet</p>
                                </section>
                                <p class="font-bold text-gray-900 text-sm">₱75.00</p>
                            </section>
                            <section class="flex justify-between items-center border-t border-gray-200/60 pt-2 text-xs text-gray-600">
        ...
        <aside id="sidebar" class="hidden absolute z-50 w-full h-fit bg-secondary text-white p-5 flex flex-col gap-3 divide-y divide-primary/20 lg:block lg:static lg:h-dvh lg:bg-white lg:text-dark-blue overflow-y-scroll scrollbar-none">
            ...
            <section class="divide-y divide-primary/20 flex flex-col gap-4 ">
                ...
                <section class="py-3 flex flex-col lg:items-center gap-1 xl:items-start">
                    ...
                    <a href=" ../admin/orderManagement.php" class="bg-primary text-white rounded-md cursor-pointer lg:w-fit h-fit px-3 py-2 flex items-center gap-3 2xl:w-full hover:bg-secondary/40 transition duration-100">
        ...
        <section class="w-full h-dvh p-5 grid grid-cols-1 gap-8  md:grid-cols-2 lg:grid-cols-4 lg:gap-3 lg:grid-rows-[auto_auto_12fr] overflow-y-scroll scrollbar-thin scrollbar-thumb-sendary">
            ...
            <section class="col-span-full flex items-center justify-between">
                <section class="flex items-center gap-3">
                    <p class="col-span-full flex items-center text-lg font-medium md:text-2xl">Orders</p>
                </section>
            ...
            <section class="col-span-full flex gap-2 items-center justify-between flex-col sm:flex-row">
                <section class="flex items-center gap-2 h-fit w-full">
                    ...
                    <!-- Filter Button -->
                    <button id="showFilterBtn" class="bg-primary text-white size-9 p-2 rounded-md flex items-center justify-center cursor-pointer hover:bg-primary/90">
                ...
                <button id="showaddRecordBtn" class="bg-primary px-4 py-2 pr-5 rounded-md text-white cursor-pointer flex items-center justify-center gap-1 w-full sm:w-80 md:w-100">
                    ...
                    <table class="table-auto w-full h-full">
                        <thead class="">
                            <tr class="bg-secondary text-white">
                                <th class="text-start font-semibold text-md py-4 pl-5 rounded-tl-md md:table-cell">Order Number</th>
                                <th class="text-start font-semibold text-md py-4 pl-5 hidden w-[55%] sm:w-[75%] md:w-100 md:table-cell lg:w-70">Supplier</th>
                                <th class="text-start font-semibold text-md py-4 pl-5 w-50 hidden xl:table-cell">Order Date</th>
                                <th class="text-start font-semibold text-md py-4 pl-5 hidden xl:table-cell">Fullfillment Status</th>
                        ...
                        <tbody class="text-sm">
                            ...
                            <tr class="h-1 border-b border-gray-100 hover:bg-gray-50/50 transition-colors">
                                ...
                                <td class="max-w-[0] truncate py-4 pl-5 hidden xl:table-cell">
                                    <span class="bg-red-50 border border-red-200 text-red-700 text-xs font-semibold px-3 py-1 rounded-full inline-flex items-center justify-center">
                                        Incomplete
                                    </span>
                                </td>
                            ...
                            <tr class="h-1 colspan-full">
                                <td colspan="7">
                                    <div class="w-full h-full flex flex-col items-center justify-center gap-2 p-15 text-center">
                                        <img class="size-35 lg:size-100" src="../../assets/image/empty_order.png" alt="">
                                        <p class="font-semibold">Oops! There are no order records here...</p>
                                        <p class="text-gray-600/80">There are no recorded orders here. Try to create new order to see records.</p>
                                        <button class="bg-primary px-4 py-2 rounded-md text-white cursor-pointer">Create new order</button>
                                    </div>
                                </td>
                            </tr>
                            <!-- No Stock Left -->
    ...
    <script>
        ...
        $("#showaddRecordBtn").click(() => {
            $("#addRecordPanel").toggleClass("hidden");
        })
        $("#closeAddRecordBtn").click(() => {
            $("#addRecordPanel").toggleClass("hidden");
        })

        // Modify this function when showing row. It needs an ID Parameter to show the details of specific row
        $(".viewDetailBtn").click(() => {
            $("#viewDetailPanel").toggleClass("hidden");
        })
        $("#closeViewDetailPanelBtn").click(() => {
            $("#viewDetailPanel").toggleClass("hidden");
        })
