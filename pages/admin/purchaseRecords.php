        ...
        <aside id="sidebar" class="hidden absolute z-50 w-full h-fit bg-secondary text-white p-5 flex flex-col gap-3 divide-y divide-primary/20 lg:block lg:static lg:h-full lg:bg-white lg:text-dark-blue">
            ...
            <section class="divide-y divide-primary/20 flex flex-col gap-4 ">
                ...
                <section class="py-3 flex flex-col lg:items-center gap-1 xl:items-start">
                    ...
                    <a href=" ../admin/purchaseRecords.php" class="bg-primary text-white rounded-md cursor-pointer lg:w-fit h-fit px-3 py-2 flex items-center gap-3 2xl:w-full hover:bg-secondary/40 transition duration-100">
        ...
        <section class="w-full h-full p-5 grid grid-cols-1 gap-8  md:grid-cols-2 lg:grid-cols-4 lg:gap-3 lg:grid-rows-[auto_auto_12fr]">
            ...
            <section class="col-span-full flex items-center justify-between">
                <section class="flex items-center gap-3">
                    <p class="col-span-full flex items-center text-lg font-medium md:text-2xl">Purchase Records</p>
                </section>
                            ...
                            <tr class="h-1 colspan-full">
                                <td colspan="7">
                                    <div class="w-full h-full flex flex-col items-center justify-center gap-2 p-15 text-center">
                                        ...
                                        <p class="font-semibold">Oops! There are no purchase record saved here...</p>
                                        <p class="text-gray-600/80">There are no recorded purchase record here. Try to submit new order to any supplier to see records.</p>
                                        <a href="../admin/orderManagement.php" button class="bg-primary px-4 py-2 rounded-md text-white cursor-pointer">Order Stock</a>
                                    </div>
                                </td>
                            </tr>
                            <!-- No Stock Left -->
